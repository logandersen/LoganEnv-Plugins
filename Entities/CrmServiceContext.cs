...
namespace Xrm
{
	...
	public partial class CrmServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Xrm.CustomerAddress"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Xrm.CustomerAddress> CustomerAddressSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<Xrm.CustomerAddress>();
			}
		}
	}
